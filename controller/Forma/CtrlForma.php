...
class CtrlForma extends FormaDAO{
        ...
        public function data(){
         $listForma=[];
            ...
            foreach($listForma as $key => $rowForma){    
              ...
              $array['data'][$key]['idConcepto'] = $rowForma['con_id'];
              $array['data'][$key]['descripcion'] = $rowForma['con_descripcion'];
              $array['data'][$key]['estado'] = $rowForma['con_estado'];
         ...
         public function postNew()
    {
       //dd($_POST);
        ...
        $rs = FormaDao::getInstance()->add($fp_id,$fp_descripcion,$fp_estado,$con_id,$con_descripcion,$con_estado);
