                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseConfig" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= getUrl("Ciudad", "Ciudad", "read"); ?>">Ciudad</a>
                                    <a class="nav-link" href="<?= getUrl("Departamento", "Departamento", "read"); ?>">Departamento</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseDoc" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#pagesCollapseFV" aria-expanded="false" aria-controls="pagesCollapseAuth">
                                        Factura de Venta
                                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                    </a>
                                    <div class="collapse" id="pagesCollapseFV" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="<?= getUrl("Factura", "Factura", "read"); ?>">Nueva Factura</a>
